...
public class CharacterSelectorUI : MonoBehaviour
{
    ...
    {
        "Потерявший всю семью мужчина ищет спасение в загадочной лаборатории. Урон: низкий. Накопление ультимейта: среднее. Защита: средняя. Урон ультимейта: средний.",
        "У него есть душа и он отправился на поиски своего создателя. Урон: средний. Накопление ультимейта: медленное. Защита: высокая. Урон ультимейта: высокий.",
        "Он стал добрым и перешел на сторону людей. Урон: высокий Накопление ультимейта: быстрое Защита: низкая Урон ультимейта: низкий"
    };
